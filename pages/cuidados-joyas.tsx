export default function CareGuide() {
    return (
        <section className="px-6 py-16 lg:px-20 bg-white font-commissioner">
            <div className="max-w-[800px] mx-auto">
                ...
                <div className="space-y-12">
                    {/* Bloque 1 */}
                    <div>
                        <h3 className=" text-xl font-semibold mb-4">¿Dónde guardo mis joyas?</h3>
                    ...
                    {/* Bloque 2 */}
                    <div>
                        <h3 className=" text-xl font-semibold mb-4">¿Qué debo evitar?</h3>
                    ...
                    {/* Bloque 3 */}
                    <div>
                        <h3 className=" text-xl font-semibold mb-4">¿Cómo puedo cuidarlas?</h3>
                        <p className=" text-base text-justify ">
                    ...
                    {/* Bloque 4 */}
                    <div>
                        <h3 className=" text-xl font-semibold mb-4">¿Puedo mojarlas?</h3>
                        <p className=" text-base text-justify  ">
